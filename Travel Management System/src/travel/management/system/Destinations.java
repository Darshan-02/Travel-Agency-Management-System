...
public class Destinations extends JFrame implements Runnable{
    ...
    JLabel caption;
    public void run() {
	String[] text = new String[] {"JW Marriott Hotel", "Mandarin oriental Hotel", "Four Seasons Hotel", "Raddisson Blue Hotel", "Classio Hotel", "The Bay Club Hotel", "Breeze Blow Hotel", "The Taj Hotel", "Happy Morning Motel", "River View Hotel"};
	try {
            for(int i = 0; i < 8; i++) {
	...
	caption.setFont(new Font("Tahoama", Font.PLAIN, 40));
